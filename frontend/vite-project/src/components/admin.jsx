                ...
                <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
                    <div className="flex-auto p-6">
                        <div className="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                            <a href="#" className="flex cursor-pointer items-center gap-2 text-black-900 no-underline hover:text-black-500">
                        ...
                        <form className="mb-4" onSubmit={handleLogin}>
                            ...
                            <div className="mb-4">
                            <button className="grid w-full cursor-pointer select-none rounded-md border border-gray-500 bg-black py-2 px-5 text-center align-middle text-sm text-white shadow hover:border-black-600 hover:bg-black hover:text-white focus:border-indigo-600 focus:bg-indigo-600 focus:text-white focus:shadow-none" type="submit">Log In</button>

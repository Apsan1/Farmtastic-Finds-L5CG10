          ...
          <div className="mt-6 overflow-hidden rounded-xl border shadow">
            <table className="min-w-full">
              <thead className="hidden border-b lg:table-header-group">
                <tr className="">
                  <th className=""></th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 ">
                    Order ID
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600  hidden md:table-cell">
                    Customer Name
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600  hidden lg:table-cell">
                    Payment Method
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 ">
                    E-mail
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 hidden lg:table-cell text-center">
                    Amount
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 hidden lg:table-cell">
                    Status
              ...
              <tbody className="lg:border-gray-300 justify-center">
                ...
                <tr className="text-center">
                  ...
                  <td className=" mx-auto whitespace-no-wrap py-4 text-sm font-bold text-black sm:px-6">
                    #130
                  </td>
                  <td className="whitespace-no-wrap py-4 text-sm font-medium text-black sm:px-6 hidden md:table-cell">
                    Biplavi
                  </td>
                  <td className="whitespace-no-wrap py-4 text-sm font-medium text-black sm:px-6 hidden lg:table-cell">
                    COD
                  </td>
                  <td className="whitespace-no-wrap py-4 text-sm font-medium text-black sm:px-6">
                    01 May, 2024
                  ...
                  <td className="whitespace-no-wrap hidden py-4 text-sm font-normal text-black sm:px-6 lg:table-cell">
                    <div className="inline-flex items-center rounded-full bg-green-600 py-2 px-6 text-xs text-white">
                      Paid
                    </div>
                  </td>
                </tr>
                ...
                <tr className="text-center">
                  ...
                  <td className="whitespace-no-wrap py-4 text-sm font-bold text-black sm:px-6">
                    #130
                  </td>
                  <td className="whitespace-no-wrap py-4 text-sm font-medium text-black sm:px-6 hidden md:table-cell">
                    Kritika
                  ...
                  <td className="whitespace-no-wrap hidden py-4 text-sm font-normal text-black sm:px-6 lg:table-cell">
                    <div className="inline-flex items-center rounded-full bg-red-500 py-2 px-3 text-xs text-white">
                      Pending
                    </div>
                  </td>
                </tr>
                ...
                <tr className="text-center">
                  ...
                  <td className="whitespace-no-wrap hidden py-4 text-sm font-normal text-black sm:px-6 lg:table-cell">
                    <div className="inline-flex items-center rounded-full bg-blue-500 py-2 px-5 text-xs text-white">
                      Partial
                    </div>
                  </td>
                </tr>

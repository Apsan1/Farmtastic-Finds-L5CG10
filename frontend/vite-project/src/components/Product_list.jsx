  ...
  return (
    <div className="w-screen">
      <div className="mx-auto mt-8 max-w-screen-xxl px-20">
        <h1 className="flex-1 text-xl font-bold text-gray-900 mb-4">
          Product List
        </h1>
          ...
          <div className="mt-6 overflow-hidden rounded-xl border shadow">
            <table className="min-w-full">
              <thead className="hidden border-b lg:table-header-group">
                <tr className="">
                  <th className=""></th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 sm:px-6">
                    Product ID
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 sm:px-6 hidden md:table-cell">
                    Category
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 sm:px-6 hidden lg:table-cell">
                    Product
                  </th>
                  <th className="border-b py-4 text-m font-medium text-gray-600 sm:px-6">
                    Price
              ...
              <tbody className="lg:border-gray-300">
                ...
                <tr className="">
                  ...
                  <td className="whitespace-no-wrap py-4 px-6 text-right text-sm font-medium text-black lg:text-left hidden lg:table-cell">
                    50 kg
                  </td>
                  <td className="whitespace-no-wrap hidden py-4 text-sm font-normal text-black sm:px-6 lg:table-cell">
                    <div className="inline-flex items-center rounded-full bg-green-600 py-2 px-7 text-xs text-white">
                      Instock
                    </div>
                  </td>
                </tr>
